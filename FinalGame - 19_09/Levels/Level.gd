...
onready var checkpoint: = $Camera2D/CheckpointReach
...
onready var big_jelly: = $Camera2D/MenuButtons/BigJellyCounter/CollectBJ
...
func _on_collect(collider_val):
	...
	elif collider_val == "Big":
		big_jelly.visible = true
	else: pass

#	if all jellyfish are collected
	if jelly.visible == true and jelly2.visible == true and jelly3.visible == true and smll_jelly.visible == true and smll_jelly2.visible == true and smll_jelly3.visible == true and smll_jelly4.visible == true and big_jelly.visible == true:
